                                    ...
                                    <div class="manga_info">
                                        <ul>
                                            <li class="d-flex flex-wrap watch justify-content-end">
                                                <c:if test="${isCrawl == false}">
                                                    <c:if test="${sessionScope.userSession == null}">
                                                        <a class="mr-2 disabled-link" href="javascript:navigateChapters(1)"><i class="fa-solid fa-arrow-left"></i> Prev</a>
                                                        <a href="javascript:navigateChapters(-1)" class="disabled-link">Next <i class="fa-solid fa-arrow-right"></i></a>
                                                        </c:if>
                                                        <c:if test="${sessionScope.userSession != null}">
                                                            <c:if test="${sessionScope.userSession.getRole().equals('Premium') || sessionScope.userSession.getRole().equals('Author')}">
