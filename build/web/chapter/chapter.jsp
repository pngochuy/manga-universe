...
<html lang="en">
    ...
    <body>
        ...
        <!-- Vendor JS Files -->
        <div id="fb-root"></div>
        <script async defer crossorigin="anonymous" src="https://connect.facebook.net/en_GB/sdk.js#xfbml=1&version=v18.0&appId=658565436099843" nonce="deUfXOoO"></script>
