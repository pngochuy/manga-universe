                            ...
                            <div class="row">
                                <div class="col-lg-6 d-none d-lg-block bg-password-image">
                                    ...
                                    <img class="w-100 img-fluid"
                                         src="http://res.cloudinary.com/djytvqlon/image/upload/v1696507608/t6plxvqducox94cokk90.jpg" alt="">
                                ...
                                <div class="col-lg-6">
                                    <div class="p-5">
                                        ...
                                        <ol class="list-unstyled">
                                            ...
                                            <li><span class="text-primary text-medium">2. </span>Our system will send you an OTP to your email
                                            </li>
