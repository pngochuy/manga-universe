                                                ...
                                                <p>
                                                    <c:if test="${isCrawl == true}">
                                                        ...
                                                        <c:forEach items="${categoriesByMangaDetail}" var="category" varStatus="loop">
                                                            <a href="OneGenreServlet?selectedCategory=${category.type}&isCrawl=${isCrawl}">${category.type}</a>
                                                ...
                                                <c:if test="${isCrawl == false}">
                                                    ...
                                                    <c:if test="${sessionScope.userSession != null}">
                                                        <c:if test="${isCrawl == false}">
                                                            ...
                                                            <a href="FollowMangaServlet?mangaID=${mangaDetail.getMangaID()}" id="follow-button" style="background-color: #9613AD" class="btn ${isFollow == true ? 'unfollow' : 'follow'}">${isFollow == true ? 'Unfollow' : 'Follow'}</a>	
                                                        </c:if>
                                                    </c:if>
                                                </c:if>
                                            </li>
