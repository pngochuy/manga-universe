 ...
 * @author PC
 */
public class DeleteMangaServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        // delete category
//        boolean c2 = mangaCategoryDAO.deleteCategories(mangaID);

        response.sendRedirect("viewMangaList.jsp");
//        request.getRequestDispatcher("viewMangaList.jsp").forward(request, response);
    }
