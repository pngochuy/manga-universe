                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form id="reportForm" action="ManageReport" method="GET">
                                                    ...
                                                    <div class="mb-3">
                                                        <label for="mangaID" class="form-label">ID manga Report:</label>
                                                        <input type="number" class="form-control" id="mangaID" name="mangaID" rows="1" placeholder="Enter your mangaID report" required></input>
                                                    </div>
